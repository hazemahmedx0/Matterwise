'use client';
import MainSideBar from '@/components/mainNavigation/MainSideBar';
...
const MainLayout = ({
  ...
  return (
    <div className="flex">
      ...
      >
        <Panel order={1} defaultSizePercentage={14} className="h-screen">
        ...
        {isVisible ? (
          <>
            ...
            <Panel defaultSizePercentage={24} order={3}>
              <Threads />
            </Panel>
          </>
        ) : null}
